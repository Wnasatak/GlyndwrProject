...
object AppConstants { // Constrants  used in splash screen and about app and about developer screen
    const val VERSION_NAME = "0.00.754"// App Still under development is a basic very early version needs more improvments :)
